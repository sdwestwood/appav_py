...
from src.eeglib.eeg import EEG
...
class Helper():
    ...
    def __init__(self, data, sampleRate=None, windowSize=None, names=None,
        ...
        #ICA check
        if ICA:
            ica=FastICA(tol=0.05,max_iter=500)
...
class DEAPHelper(Helper):
    """
    This class is for applying diferents operations using the EEG class over the DEAP H5 file.
    """
